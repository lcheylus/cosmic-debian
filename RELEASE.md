...
- update `VERSION` variable in **Build COSMIC apps** and **Build COSMIC
components** workflows and commit them
...
- the **Publish COSMIC release** workflow will start automatically, build Debian
packages and publish a new release
